<div x-data="wireui_datetime_picker({
    model: @entangleable($attributes->wire('model')->value),
})"
    x-props="{
        config: {
    ...
    <x-dynamic-component :component="WireUi::component('input')"
        {{ $attributes->whereDoesntStartWith(['wire:model', 'x-model', 'wire:key', 'readonly','value']) }} :borderless="$borderless"
                    ...
                    <div
                        ...
                        @if ($clearable)
                            <x-dynamic-component :component="WireUi::component('icon')"
                                class="cursor-pointer w-4 h-4 hover:text-red-400 transition-colors ease-in-out duration-150"
